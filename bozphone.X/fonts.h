...
// bit patterns for the CP437 8x8 font (knicked from somewhere on internet, thanks to whoever!)
// See png in same folder for the picture of each font

const unsigned char cp437 [256] [8] = 
{
